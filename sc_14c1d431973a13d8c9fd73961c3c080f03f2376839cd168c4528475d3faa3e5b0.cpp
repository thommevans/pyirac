...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    arr_blitz_not_buggy(blitz::Range(0,sh-1))=arr(blitz::Range(0,_end));
...
PyMODINIT_FUNC initsc_14c1d431973a13d8c9fd73961c3c080f03f2376839cd168c4528475d3faa3e5b0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_14c1d431973a13d8c9fd73961c3c080f03f2376839cd168c4528475d3faa3e5b0", compiled_methods);
}
