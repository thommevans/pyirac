...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    arr_blitz_not_buggy(blitz::Range(2,sh-1))=arr(blitz::Range(2,_end));
...
PyMODINIT_FUNC initsc_8f6fc8270683786381b0fd4de41c4e04c7f78acc22957670fbad054e396cfbb60(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_8f6fc8270683786381b0fd4de41c4e04c7f78acc22957670fbad054e396cfbb60", compiled_methods);
}
