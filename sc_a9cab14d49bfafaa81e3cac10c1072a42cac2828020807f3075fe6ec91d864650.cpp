...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    arr_blitz_buggy(blitz::Range(2,_end))=arr(blitz::Range(2,_end));
...
PyMODINIT_FUNC initsc_a9cab14d49bfafaa81e3cac10c1072a42cac2828020807f3075fe6ec91d864650(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_a9cab14d49bfafaa81e3cac10c1072a42cac2828020807f3075fe6ec91d864650", compiled_methods);
}
