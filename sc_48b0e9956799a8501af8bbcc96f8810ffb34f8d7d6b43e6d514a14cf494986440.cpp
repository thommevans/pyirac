...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    PyObject *py_arr_blitz_buggy, *py_arr;
    py_arr_blitz_buggy = py_arr = NULL;
    ...
    py_arr_blitz_buggy = get_variable("arr_blitz_buggy",raw_locals,raw_globals);
    PyArrayObject* arr_blitz_buggy_array = convert_to_numpy(py_arr_blitz_buggy,"arr_blitz_buggy");
    conversion_numpy_check_type(arr_blitz_buggy_array,PyArray_DOUBLE,"arr_blitz_buggy");
    conversion_numpy_check_size(arr_blitz_buggy_array,1,"arr_blitz_buggy");
    blitz::Array<double,1> arr_blitz_buggy = convert_to_blitz<double,1>(arr_blitz_buggy_array,"arr_blitz_buggy");
    blitz::TinyVector<int,1> Narr_blitz_buggy = arr_blitz_buggy.shape();
    ...
    arr_blitz_buggy(blitz::Range(1,_end))=arr(blitz::Range(1,_end));
...
PyMODINIT_FUNC initsc_48b0e9956799a8501af8bbcc96f8810ffb34f8d7d6b43e6d514a14cf494986440(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_48b0e9956799a8501af8bbcc96f8810ffb34f8d7d6b43e6d514a14cf494986440", compiled_methods);
}
