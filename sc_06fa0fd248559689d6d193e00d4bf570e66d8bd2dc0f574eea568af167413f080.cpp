...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    arr_blitz_buggy(blitz::Range(0,_end))=arr(blitz::Range(0,_end));
...
PyMODINIT_FUNC initsc_06fa0fd248559689d6d193e00d4bf570e66d8bd2dc0f574eea568af167413f080(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_06fa0fd248559689d6d193e00d4bf570e66d8bd2dc0f574eea568af167413f080", compiled_methods);
}
